                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="slide-text">
                                            ...
                                            <p>Miker Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                                           <div class="slide-buttons">
                                                <a href="#" class="slide-btn btn btn-base">Download Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="slide-text">
                                           ...
                                           <h1>ÊTES VOUS PRÊTS  <br> A POSTULER?</h1>
                                            ...
                                            <div class="slide-buttons">
                                                <a href="#" class="slide-btn btn btn-base">Get Start Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row section-separator">
                    <div class="col-sm-4">
                        <div class="uv-join-tagline wow fadeInRight" data-wow-delay="0.2s">
                            <h2><b>Smarter</b> way to go through your school</h2>
                    ...
                    <div class="col-sm-8">
                        <div class="uv-featured-icon wow fadeIn" data-wow-delay="0.2s">
                            <div class="row">
                                <ul>
                                    <li class="col-sm-3 col-xs-6"><i class="fa flaticon-mortarboard-1"></i><span>The Open University</span></li>
                                    <li class="col-sm-3 col-xs-6"><i class="fa flaticon-monitor"></i><span>Digital Education</span></li>
                                    <li class="col-sm-3 col-xs-6"><i class="fa flaticon-light-bulb "></i><span>Technical Workshops</span></li>
                                    <li class="col-sm-3 col-xs-6"><i class="fa flaticon-open-book"></i><span>Online Learning</span></li>
                                </ul>
                            </div>
                            <h5>A private institution with a public purpose, Ransom Everglades combines 
                            rigorous college preparation.</h5>
                        </div>
                    ...
                    <div class="col-sm-4 wow fadeInUp">
                        ...
                        <div class="featured-post-inner uv-hover-style">
                            ...
                            <div class="uv-post-inner-content">
                                <h6>Bring Youth to Fun & Study</h6>
                    ...
                    <div class="uv-each-events col-xs-12">
                        <ul>
                            ...
                            <li class="wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="col-sm-6">
                                    <div class="uv-event-content">
                                        <a href=""><h4>How to Become Successful</h4></a>
                            ...
                            <li class="wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="col-sm-6">
                                    <div class="uv-event-content">
                                        <a href=""><h4>How to Find a College That Fits You</h4></a>
                                        <p>Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt 
                                        auctor a ornare odio. Sed non mauris itae erat conuat</p>
                                    </div>
                                </div>
                            ...
                            <li class="wow fadeInUp" data-wow-delay="0.6s">
                                ...
                                <div class="col-sm-6">
                                    <div class="uv-event-content">
                                        <a href=""><h4>The Right High School: Myth Versus Reality</h4></a>
                                        <p>Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt 
                                        auctor a ornare odio. Sed non mauris itae erat conuat</p>
                                    </div>
                                </div>
                            ...
                            <div class="blog-inner">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="blog-schedule">
                                        <a href=""><h4>10 Reasons Why Postgraduate Study Might Be Right For You</h4></a>
                                        <div class="blog-meta">
                        ...
                        <div class="item">
                            <div class="blog-inner">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="blog-schedule">
                                        <a href=""><h4>10 of the Best Student Blogs for Millennial Life</h4></a>
                                        <div class="blog-meta">
                        ...
                        <div class="item">
                            <div class="blog-inner">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="blog-schedule">
                                        <a href=""><h4>Why Your Choice Of Verb Helps You Evaluate A Text</h4></a>
                                        <div class="blog-meta">
