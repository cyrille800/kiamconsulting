...
?>
            ...
            if(isset($_GET["operation"])){
                if($_GET["operation"]=="accepter"){
                    $requette=config::$bdd->query("update patient set resultat=1 where id_client=".$_GET["id"]);
                }
                if($_GET["operation"]=="refuser"){
                    $requette=config::$bdd->query("update patient set resultat=-2 where id_client=".$_GET["id"]);
                }
